    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                { name: 'Email' }, { name: 'Remark' }, { name: 'CreateDate', type: 'date' }, { name: 'Sex' }, { name: 'Phone' }, { name: 'IndutyData' }, { name: 'OutdutyDate' }
                ]
            });
            ...
            { id: 'Phone', header: '手机', width: 120, sortable: true, dataIndex: 'Phone' },
            { id: 'Sex', header: '性别', width: 60, sortable: true, dataIndex: 'Sex' },
            { id: 'IndutyData', header: '入职日期', width: 80, sortable: true, dataIndex: 'IndutyData', renderer: Ext.util.Format.dateRenderer('Y/m/d') },
            { id: 'OutdutyDate', header: '离职日期', width: 80, sortable: true, dataIndex: 'OutdutyDate', renderer: Ext.util.Format.dateRenderer('Y/m/d') },
            { id: 'Remark', header: '备注', width: 100, sortable: true, dataIndex: 'Remark' },
            { id: 'CreateDate', header: '创建时间', width: 100, align: 'center', renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'CreateDate' }
            ],
                    bbar: pgBar,
                    tbar: titPanel,
                    frame: true,
            ...
            function openMdlWin(url, op, style) {
                op = op || "r";
                style = style || "dialogWidth:450px; dialogHeight:380px; scroll:yes; center:yes; status:no; resizable:yes;";
