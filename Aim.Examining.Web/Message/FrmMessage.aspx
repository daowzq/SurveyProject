<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/formpage.master" AutoEventWireup="true"
    CodeBehind="FrmMessage.aspx.cs" Inherits="Aim.Examining.Web.Message.FrmMessage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            if (pgOperation == "fb") {
                $("#ReleaseUser").val(AimState.UserInfo.Name);
                $("#ReleaseId").val(AimState.UserInfo.UserID);
                $("#ReleaseTime").val(jQuery.dateOnly(AimState.SystemInfo.Date));

                $("#trfb1").attr("style", { "display": "block" });
                //$("#trfb2").attr("style", { "display": "block" });
                $("#btnRelease").attr("style", { "display": "block" });
            }
        ...
        function SuccessSubmit() {
            AimFrm.submit(pgAction, { "Section": $("#Typeid").find("option:selected").text() }, null, SubFinish); //, "content": document.getElementById("eWebEditor1").contentWindow.getHTML()
        }
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data">
                        <input id="RemindDays" name="RemindDays" class="validate[required custom[onlyInteger]]"
                            style="width: 200px;" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="aim-ui-td-data" colspan="3">
                        <textarea id="Content" name="Content" aimctrl="editor" style="width: 80%; height: 300px;"></textarea>
                ...
                <tr>
                    <td class="aim-ui-button-panel" colspan="4">
                        <a id="btnSubmit" class="aim-ui-button submit">提交</a> <a id="btnRelease" class="aim-ui-button fabu"
                            style="display: none;">发布</a> <a id="btnCancel" class="aim-ui-button cancel">取消</a>
                    </td>
                </tr>
            </tbody>
        </table>
