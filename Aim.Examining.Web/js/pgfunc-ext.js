...
function ExtGetExcelXml(cmp, config) {
    ...
    if ($.isArray(cmp) && cmp.length > 1) {
        ...
        //modify By Wgm 2014/2/8
        var xmlData = cmp.getExcelXml(includeHidden, config);
        if ((config["title"] + "").indexOf("问卷人员") > -1) {
            var repl = "<ss:Row ss:Height=\"38\"><ss:Cell ss:StyleID=\"title\" ss:MergeAcross=\"6\"><ss:Data xmlns:html=\"http://www.w3.org/TR/REC-html40\" ss:Type=\"String\"><html:B>问卷人员</html:B></ss:Data><ss:NamedCell ss:Name=\"PrintTitles_ext_comp_1032\" /></ss:Cell></ss:Row>";
            xmlData = xmlData.replace(repl, "");
            // xmlData = xmlData.replace("<ss:Worksheet ss:Name=\"问卷人员\">", "<ss:Worksheet ss:Name=\"Sheet1\">");
        }
        return xmlData;
    }
}
...
Ext.ux.form.SuperBoxSelect = Ext.extend(Ext.ux.form.SuperBoxSelect, Ext.form.ComboBox, {
    ...
    */
    ...
    doQuery: function (q, forceAll, valuesQuery, forcedAdd) {
        q = Ext.isEmpty(q) ? '' : q;
        if (this.queryFilterRe && this.queryFilterRe.toString() != "") {
