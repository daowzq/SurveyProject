<%@ Page Title="员工体检" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="true" CodeBehind="UsrHealthyWelfareEdit.aspx.cs" Inherits="Aim.Examining.Web.UsrHealthyWelfareEdit" %>
        ...
        function IniOpinion() {
            ...
            if (AimState["Opinion"] && AimState["Opinion"].length > 0) {
                ...
                for (var i = 1; i < myData.length; i++) {//从1开始 是为了不显示自动提交的任务
                    ...
                    td.innerHTML = '<textarea rows="2" disabled style="width: 97%; background-color:gray;">' + Description + '</textarea>';
                    td.colSpan = 6;
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data" colspan="3">
                        <input id="CompanyName" name="CompanyName" readonly="readonly" aimctrl="popup" popurl="/CommonPages/Select/CustomerSlt/MiddleOrgView.aspx?seltype=single"
                            popparam="CompanyId:GroupID;CompanyName:Name" popstyle="width=320,height=400"
                            class="validate[required]" style="width: 88%" />
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data" colspan="3">
                        <input id="DeptName" name="DeptName" readonly="readonly" aimctrl="popup" popurl="/CommonPages/Select/CustomerSlt/MiddleOrgView.aspx?seltype=single"
                            popparam="DeptId:GroupID;DeptName:Name" popstyle="width=320,height=400" class="validate[required]"
                            style="width: 88%" />
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data" colspan="4">
                        <textarea name="Reason" id="Reason" rows="10" style="width: 93%"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="aim-ui-td-caption">
                    ...
                    <td class="aim-ui-td-data" colspan="4">
                        <input type="hidden" id="AddFiles" style="width: 95%" name="AddFiles" aimctrl='file'
