<%@ Page Title="妇女节福利" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="UsrWomanWelfareList.aspx.cs" Inherits="Aim.Examining.Web.UsrWomanWelfareList" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        var EditWinStyle = CenterWin("width=660,height=420,scrollbars=yes");
        var EditPageUrl = "UsrWomanWelfareEdit.aspx";
        ...
        function setPgUI() {
            ...
            myData = {
                ...
                records: AimState["UsrWomanWelfareList"] || []
            };

            // 表格数据源
            store = new Ext.ux.data.AimJsonStore({
                dsname: 'UsrWomanWelfareList',
                idProperty: 'Id',
                data: myData,
                fields: [
			{ name: 'Id' },
            ...
            tlBar = new Ext.ux.AimToolbar({
                ...
                grid = new Ext.ux.grid.AimGridPanel({
					...
					{ id: 'DeptName', dataIndex: 'DeptName', header: '部门', width: 180, sortable: true },
                    // { id: 'Sex', dataIndex: 'Sex', header: '性别', width: 80, sortable: true },
					{id: 'Age', dataIndex: 'Age', header: '年龄', width: 80, sortable: true },
					{ id: 'IsMarry', dataIndex: 'IsMarry', header: '是否已婚', width: 80, renderer: RowRender },
