<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/formpage.master" AutoEventWireup="true"
    CodeBehind="TreatyDialog.aspx.cs" Inherits="Aim.Examining.Web.EmpWelfare.TreatyDialog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            if (!$.isEmptyObject(AimState["Ent"])) {
                $("#TreatyContent").append(AimState["Ent"]["TreatyContent"]);
            }
        }
