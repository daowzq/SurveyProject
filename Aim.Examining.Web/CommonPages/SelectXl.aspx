<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SelectXl.aspx.cs" Inherits="Aim.Examining.Web.CommonPages.SelectXl" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                collapsed: false,
                columns: 2,
                items: [{ fieldLabel: '学历', id: 'XL', schopts: { qryopts: "{ mode: 'Like', field: 'XL' }"}}]
            });
                ...
                AimSelGrid = new Ext.ux.grid.AimGridPanel({
                    ...
                    { id: 'Id', dataIndex: 'Id', header: 'Id', hidden: true },
                     new Ext.ux.grid.AimRowNumberer(),
                      AimSelCheckModel,
                    { id: 'XL', dataIndex: 'XL', header: '学历', width: 200}],
                    tbar: titPanel
                });
