<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SelectGWXL.aspx.cs" Inherits="Aim.Examining.Web.CommonPages.SelectGWXL" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                collapsed: false,
                columns: 2,
                items: [{ fieldLabel: '岗位序列', id: 'XL', schopts: { qryopts: "{ mode: 'Like', field: 'XL' }"}}]
            });
            ...
            tlBar = new Ext.ux.AimToolbar({
                ...
                AimSelGrid = new Ext.ux.grid.AimGridPanel({
                    ...
                    { id: 'Id', dataIndex: 'Id', header: 'Id', hidden: true },
                     ...
                     AimSelCheckModel,
                    { id: 'XL', dataIndex: 'XL', header: '岗位序列', width: 200}],
                    tbar: titPanel
                });
